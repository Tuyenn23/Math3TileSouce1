...
namespace Greenknight
{
    public class AdsHelper : MonoBehaviour
    {
        ...
        private bool IsVideoRewardedAdReady(RewardedAdNetwork pNetwork = RewardedAdNetwork.None)
        {
            ...
            if (pNetwork == RewardedAdNetwork.None)
            {
                if (AdsManager.Instance.IsRewardedAdReady(RewardedAdNetwork.AdMob))
                    ...
                    return true;
                            ...
                            return true;
                else if (AdsManager.Instance.IsRewardedAdReady(RewardedAdNetwork.MAX))
                    return true;
            }
            ...
            else if (pNetwork == RewardedAdNetwork.MAX)
            {
                if (AdsManager.Instance.IsRewardedAdReady(RewardedAdNetwork.MAX))
                    return true;
            }
            return false;
#endif
        ...
        {
            GameTracking.LogEvent("show_rewarded_ads_" + id);
        ...
        {
            pNetwork = InterstitialAdNetwork.MAX;
            if (IsInterstitialAdReady())
            {
